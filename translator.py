# GUIDE TO TRANSLATE LANGUAGES USING Google Translate API
...
# Title of the app
title_label = Label(
    window, text="Language Translator Using Python", font=("Gayathri", 12)
).pack()
# Read inputs
# Text input
...
button1 = Button(
    window, text="Translate", bg="Turquoise", command=translate_function
).place(x=160, y=190)
button2 = Button(window, text="Clear", bg="Turquoise", command=clear).place(
    x=270, y=190
)
# close the app
window.mainloop()
